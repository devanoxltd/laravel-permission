...
1. Composer. Upgrading between major versions of this package always requires the usual Composer steps:
   ...
   - Then run `composer update devanoxltd/laravel-permission`.
...
8. Review the changelog, which details all the changes: [CHANGELOG](https://github.com/devanoxltd/laravel-permission/blob/main/CHANGELOG.md)
and/or consult the [Release Notes](https://github.com/devanoxltd/laravel-permission/releases)
